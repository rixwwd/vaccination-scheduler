insert into rooms (id, name, created_at, updated_at) values ('107c201a-790c-4fcf-bd86-ad60d5f15d39', '市役所 会議室1', current_timestamp, current_timestamp);

insert into cells (id, room_id, begin_time, end_time, max_number_of_people, created_at, updated_at) values 
